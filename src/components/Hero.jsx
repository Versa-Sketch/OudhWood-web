      ...
      <section className="framer-a6uc3n" data-framer-name="Hero">
          ...
          <div className="framer-1kzlz1n" data-framer-name="Cover">
            <div className="framer-16ruhe7" data-framer-name="Inner">
              <div className="framer-1prag56" data-framer-name="Description">
                <div className="ssr-variant">
                  <div className="framer-5q3pf5-container">
                    <div className="framer-t7M5S framer-riLfm framer-pqt00z framer-v-1vxzlfb" data-framer-name="White" style={{ "--1ejae7j": "flex-start", width: "100%" }}>
                      <div className="framer-12zpxkc" data-border="true" data-framer-name="Icon" style={{ "--border-bottom-width": "0.5px", "--border-color": "var(--token-7b96a2a6-c774-41aa-9a64-c9f85c5960c2, rgb(255, 255, 255))", "--border-left-width": "0.5px", "--border-right-width": "0.5px", "--border-style": "solid", "--border-top-width": "0.5px", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                        <div className="framer-1mlw5gd" data-framer-name="Dot" style={{ backgroundColor: "var(--token-7b96a2a6-c774-41aa-9a64-c9f85c5960c2, rgb(255, 255, 255))", borderBottomLeftRadius: "50px", borderBottomRightRadius: "50px", borderTopLeftRadius: "50px", borderTopRightRadius: "50px" }}>
                        </div>
                      </div>
                      <div className="framer-2pahix" data-framer-component-type="RichTextContainer" style={{ "--extracted-r6o4lv": "var(--token-7b96a2a6-c774-41aa-9a64-c9f85c5960c2, rgb(255, 255, 255))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <p className="framer-text framer-styles-preset-1c0cf2x" data-styles-preset="qEbsElzxw" dir="auto" style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-7b96a2a6-c774-41aa-9a64-c9f85c5960c2, rgb(255, 255, 255)))" }}>{`Welcome to Mrida`}</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="framer-18m5fyz" data-framer-component-type="RichTextContainer" style={{ transform: "none" }}>
                  <p className="framer-text framer-styles-preset-42ve16" data-styles-preset="dKIPjMLJB" dir="auto" style={{ "--framer-text-color": "var(--token-7b96a2a6-c774-41aa-9a64-c9f85c5960c2, rgb(255, 255, 255))" }}>{`Mrida links farmers and Agarwood Plantations in a transparent, profitable partnership — built to pay you first.`}</p>
                </div>
              </div>
