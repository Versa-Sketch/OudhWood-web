            ...
            <div className="framer-6s1p7b" data-framer-name="Title Section">
              <div className="framer-1ds6z00" data-framer-name="Title">
                <div className="ssr-variant">
                  <div className="framer-sdqwux-container">
                    <div className="framer-t7M5S framer-riLfm framer-pqt00z framer-v-lg75cy" data-framer-name="Grey" style={{ "--1ejae7j": "flex-start", width: "100%" }}>
                      ...
                      <div className="framer-2pahix" data-framer-component-type="RichTextContainer" style={{ "--extracted-r6o4lv": "var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <p className="framer-text framer-styles-preset-1c0cf2x" data-styles-preset="qEbsElzxw" dir="auto" style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112)))" }}>{`The Mrida Agarwood Journal`}</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="framer-9xh79y" data-framer-component-type="RichTextContainer" style={{ transform: "none" }}>
                  <h2 className="framer-text framer-styles-preset-1vb0x0m" data-styles-preset="emYHIiQDN" dir="auto" style={{ "--framer-text-color": "var(--token-85d98d03-893a-4262-a7bf-f1c29a1e4abe, rgb(0, 0, 0))" }}>{`Honest, practical insight on what your Agarwood trees are worth`}</h2>
                </div>
              </div>
            ...
            <div className="framer-16uz0ql">{/*$*/}{/*$*/}
              <div className="ssr-variant">
                <div className="framer-1u91fe5-container">{/*$*/}<a className="framer-dWkFy framer-riLfm framer-1EFv6 framer-6c3n9 framer-1kpvnzf framer-v-1kpvnzf framer-1wmouwt" data-framer-name="Default" href="./blog/creating-timeless-interiors-for-modern-lifestyles" style={{ width: "100%" }}>
                    ...
                    <div className="framer-19zudmo" data-framer-name="Post Details">
                      <div className="framer-18ez0jz" data-framer-name="Meta">
                        <div className="framer-1m4la1v" data-framer-component-type="RichTextContainer" style={{ "--extracted-r6o4lv": "var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <p className="framer-text framer-styles-preset-1c0cf2x" data-styles-preset="qEbsElzxw" dir="auto" style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112)))" }}>{`May 14, 2026`}</p>
                        </div>
                        <div className="framer-p5m1do" data-framer-component-type="RichTextContainer" style={{ "--extracted-r6o4lv": "var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <p className="framer-text framer-styles-preset-1c0cf2x" data-styles-preset="qEbsElzxw" dir="auto" style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112)))" }}>{`•`}</p>
                        </div>
                        <div className="framer-y0o611" data-framer-component-type="RichTextContainer" style={{ "--extracted-r6o4lv": "var(--token-85d98d03-893a-4262-a7bf-f1c29a1e4abe, rgb(0, 0, 0))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <p className="framer-text framer-styles-preset-1c0cf2x" data-styles-preset="qEbsElzxw" dir="auto" style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-85d98d03-893a-4262-a7bf-f1c29a1e4abe, rgb(0, 0, 0)))" }}>{`For Farmers`}</p>
                        </div>
                      </div>
              ...
              <div className="ssr-variant">
                <div className="framer-1u91fe5-container">{/*$*/}<a className="framer-dWkFy framer-riLfm framer-1EFv6 framer-6c3n9 framer-1kpvnzf framer-v-1kpvnzf framer-1wmouwt" data-framer-name="Default" href="./blog/designing-sustainable-spaces-for-future-living" style={{ width: "100%" }}>
                    ...
                    <div className="framer-19zudmo" data-framer-name="Post Details">
                      <div className="framer-18ez0jz" data-framer-name="Meta">
                        <div className="framer-1m4la1v" data-framer-component-type="RichTextContainer" style={{ "--extracted-r6o4lv": "var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <p className="framer-text framer-styles-preset-1c0cf2x" data-styles-preset="qEbsElzxw" dir="auto" style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112)))" }}>{`May 12, 2026`}</p>
                        </div>
                        <div className="framer-p5m1do" data-framer-component-type="RichTextContainer" style={{ "--extracted-r6o4lv": "var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <p className="framer-text framer-styles-preset-1c0cf2x" data-styles-preset="qEbsElzxw" dir="auto" style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112)))" }}>{`•`}</p>
                        </div>
                        <div className="framer-y0o611" data-framer-component-type="RichTextContainer" style={{ "--extracted-r6o4lv": "var(--token-85d98d03-893a-4262-a7bf-f1c29a1e4abe, rgb(0, 0, 0))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <p className="framer-text framer-styles-preset-1c0cf2x" data-styles-preset="qEbsElzxw" dir="auto" style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-85d98d03-893a-4262-a7bf-f1c29a1e4abe, rgb(0, 0, 0)))" }}>{`For Investors`}</p>
                        </div>
                      </div>
                      <div className="framer-1b6s916" data-framer-name="Post Title">
                        <div className="framer-d745ob" data-framer-component-type="RichTextContainer" style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
              ...
              <div className="ssr-variant">
                <div className="framer-1u91fe5-container">{/*$*/}<a className="framer-dWkFy framer-riLfm framer-1EFv6 framer-6c3n9 framer-1kpvnzf framer-v-1kpvnzf framer-1wmouwt" data-framer-name="Default" href="./blog/smart-construction-planning-for-efficient-projects" style={{ width: "100%" }}>
                    ...
                    <div className="framer-19zudmo" data-framer-name="Post Details">
                      <div className="framer-18ez0jz" data-framer-name="Meta">
                        <div className="framer-1m4la1v" data-framer-component-type="RichTextContainer" style={{ "--extracted-r6o4lv": "var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <p className="framer-text framer-styles-preset-1c0cf2x" data-styles-preset="qEbsElzxw" dir="auto" style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112)))" }}>{`Apr 30, 2026`}</p>
                        </div>
                        <div className="framer-p5m1do" data-framer-component-type="RichTextContainer" style={{ "--extracted-r6o4lv": "var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <p className="framer-text framer-styles-preset-1c0cf2x" data-styles-preset="qEbsElzxw" dir="auto" style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-5dfb00e3-da06-4acf-a66b-903c726763b9, rgb(112, 112, 112)))" }}>{`•`}</p>
                        </div>
